 ...
 */
  ...
  KaitaiStream.prototype.readBytesTerm = function (
    terminator,
    include,
    consume,
    eosError
  ...
  KaitaiStream.processXorOne = function (data, key) {
    ...
    var dl = data.length;
    for (var i = 0; i < dl; i++) r[i] = data[i] ^ key;
    return r;
  };
  ...
  // Unused since Kaitai Struct Compiler v0.9+ - compatibility with older versions
  var UnexpectedDataError = (KaitaiStream.UnexpectedDataError = function (
    expected,
    actual
  ) {
  ...
  var UndecidedEndiannessError = (KaitaiStream.UndecidedEndiannessError =
    function () {
  ...
  var ValidationNotEqualError = (KaitaiStream.ValidationNotEqualError =
    function (expected, actual) {
      this.name = "ValidationNotEqualError";
      this.message =
        "not equal, expected [" + expected + "], but got [" + actual + "]";
      this.expected = expected;
      this.actual = actual;
      this.stack = new Error().stack;
    });
  ...
  var ValidationLessThanError = (KaitaiStream.ValidationLessThanError =
    function (min, actual) {
      this.name = "ValidationLessThanError";
      this.message =
        "not in range, min [" + min + "], but got [" + actual + "]";
      this.min = min;
      this.actual = actual;
      this.stack = new Error().stack;
    });
  ...
  var ValidationGreaterThanError = (KaitaiStream.ValidationGreaterThanError =
    function (max, actual) {
      this.name = "ValidationGreaterThanError";
      this.message =
        "not in range, max [" + max + "], but got [" + actual + "]";
      this.max = max;
      this.actual = actual;
      this.stack = new Error().stack;
    });
  ...
  var ValidationNotAnyOfError = (KaitaiStream.ValidationNotAnyOfError =
    function (actual, io, srcPath) {
  ...
  var ValidationExprError = (KaitaiStream.ValidationExprError = function (
    actual,
    io,
    srcPath
  ) {
